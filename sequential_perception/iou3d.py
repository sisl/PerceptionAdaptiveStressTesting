...
#def nusc_box_to_corners(nusc_box: EvalBox):

def evalbox_iou3d(evalbox1, evalbox2):
    box1 = Box(center=evalbox1.translation,
                size=evalbox1.size,
                orientation=Quaternion(evalbox1.rotation))
    box2 = Box(center=evalbox2.translation,
                size=evalbox2.size,
                orientation=Quaternion(evalbox2.rotation))

    iou3d = box3d_iou(box1.corners().T, box2.corners().T)
    return iou3d
