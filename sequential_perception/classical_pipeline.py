...
from sequential_perception.detectors import OpenPCDetector
from sequential_perception.kalman_tracker import MultiObjectTrackByDetection
from sequential_perception.predictors import CoverNetTrackPredictor, PipelineCoverNetModule
...
class PerceptionPipeline:
    ...
    def __init__(self, config: Dict, nuscenes: NuScenes, detector:OpenPCDetector, tracker:MultiObjectTrackByDetection, predictor:PipelineCoverNetModule):
        self.config = config
        self.nuscenes = nuscenes
